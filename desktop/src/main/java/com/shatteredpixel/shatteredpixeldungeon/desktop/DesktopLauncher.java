	...
	public static void main (String[] args) {
		...
		if (SharedLibraryLoader.isWindows) {
			if (System.getProperties().getProperty("os.name").equals("Windows XP")) {
				basePath = "Application Data/.shatteredpixel/AbyssaInite Pixel Dungeon/";
			} else {
				basePath = "AppData/Roaming/.shatteredpixel/AbyssaInite Pixel Dungeon/";
			}
		} else if (SharedLibraryLoader.isMac) {
			basePath = "Library/Application Support/AbyssaInite Pixel Dungeon/";
		} else if (SharedLibraryLoader.isLinux) {
			basePath = ".shatteredpixel/abyssainite-pixel-dungeon/";
		}
